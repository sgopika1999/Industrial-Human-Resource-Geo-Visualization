...
file_paths = [r"H:\\foldere\\industrial\\zip files\\Data1.csv",r"H:\\foldere\\industrial\\zip files\\Data2.csv" , r"H:\\foldere\\industrial\\zip files\\Data3.csv",
              r"H:\\foldere\\industrial\\zip files\\Data4.csv",r"H:\\foldere\\industrial\\zip files\\Data5.csv" , r"H:\\foldere\\industrial\\zip files\\Data6.csv",
              r"H:\\foldere\\industrial\\zip files\\Data7.csv",r"H:\\foldere\\industrial\\zip files\\Data8.csv" , r"H:\\foldere\\industrial\\zip files\\Data9.csv",
              r"H:\\foldere\\industrial\\zip files\\Data10.csv",r"H:\\foldere\\industrial\\zip files\\Data11.csv" , r"H:\\foldere\\industrial\\zip files\\Data12.csv",
              r"H:\\foldere\\industrial\\zip files\\Data13.csv",r"H:\\foldere\\industrial\\zip files\\Data14.csv" , r"H:\\foldere\\industrial\\zip files\\Data15.csv",
              r"H:\\foldere\\industrial\\zip files\\Data16.csv",r"H:\\foldere\\industrial\\zip files\\Data17.csv" , r"H:\\foldere\\industrial\\zip files\\Data18.csv",
              r"H:\\foldere\\industrial\\zip files\\Data19.csv",r"H:\\foldere\\industrial\\zip files\\Data20.csv" , r"H:\\foldere\\industrial\\zip files\\Data21.csv",
              r"H:\\foldere\\industrial\\zip files\\Data22.csv",r"H:\\foldere\\industrial\\zip files\\Data23.csv" ]
...
with tab1:
    ...
    with col1:
        st.write("")
        st.write("")
        st.image(Image.open("C:\\Users\\prave\\Downloads\\hr.jpg"), width=500)
...
with tab2:
    ...
    st.pyplot(plt)
    st.write("Rajasthan: Holds the highest number of workers.")
    st.write("Maharashtra: Ranks second in the number of workers.")           
    st.write("Tamil Nadu: Comes in third in the number of workers.")
    ...
    st.write("2. The number of female workers is higher in the marginal category than in the main category for both rural and urban areas.")
    st.write("3. There are fewer main workers in rural areas compared to urban areas.")
    st.write("4. There are more marginal workers in rural areas compared to urban areas.")
    ...
    with open("C:\\Users\\prave\\Downloads\\states_india.geojson", 'r') as file:
